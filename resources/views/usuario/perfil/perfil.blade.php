...
<body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
        ...
        <form action="/usuario/actualizar/{{ session('userId') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <input name="name" type="text" maxlength="100" required value="{{ session('userName') }}"><br><br>

            <label>Email:</label><br>
            <input type="email" name="email" maxlength="100" value="{{ session('userEmail') }}" required><br><br>

            <label>Nueva Contraseña:</label><br>
            <input type="password" name="password" value="{{ session('userPassword') }}" required placeholder="Escribe tu nueva contraseña"><br><br>
